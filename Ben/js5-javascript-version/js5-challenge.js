...
console.log(getActiveUsers(data.people));
console.log(findMatchingEyeColours(data.people, data.people[0]));
console.log(getEmailAddress(data.people, 2321));
console.log(getActiveUsersWithInvalidEmail(data.people));
console.log(addRandomMobileNumbers(data.people));
