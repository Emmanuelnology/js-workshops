...
testSuite.assertEqualGroup('Has fever', [
    {
        compare: ts3_challenge_1.hasFever(37.4),
        to: false,
        name: 'Under 37.5 doesn\'t have fever'
    },
    {
        compare: ts3_challenge_1.hasFever(37.5),
        to: true,
        name: '37.5 has a fever'
    },
    {
        compare: ts3_challenge_1.hasFever(37.6),
        to: true,
...
testSuite.assertEqualGroup('TV Height', [
    {
        compare: ts3_challenge_1.calcTVHeight(16),
        to: 9,
        name: '16 wide == 9 tall'
    },
    {
        compare: ts3_challenge_1.calcTVHeight(32),
        to: 18,
...
testSuite.assertEqualGroup('Could date', [
    {
        compare: ts3_challenge_1.couldDate(18, 22),
        to: true,
    ...
    {
        compare: ts3_challenge_1.couldDate(22, 22),
        to: true,
        name: '22 year old could date a 22 year old'
    },
    {
        compare: ts3_challenge_1.couldDate(34, 56),
        to: false,
...
testSuite.assertEqualGroup('Color Darken', [
    ...
    {
        compare: ts3_challenge_1.colorDarken({ red: 9, green: 1, blue: 9 }, 10),
        to: [0, 0, 0],
        name: 'Never go below 0'
    },
    {
        compare: ts3_challenge_1.colorDarken({ red: 9, green: 11, blue: 10 }, 8),
        to: [1, 3, 2],
        name: 'Reduce by a number that is not 10'
    },
    {
        compare: ts3_challenge_1.colorDarken({ red: 60, green: 5, blue: 60 }, 6),
        to: [54, 0, 54],
